...
2. run the following command:
  ...
  Scenario Outline: Put teacher update
    * Post to service api "<URL>" with '<data>' and I should get the '<expectval>'
    Examples: 
      | URL                                    | data                                                                                                                                                              | expectval                                           |
      | http://localhost:3000/teacher/update/1 | { "Email":"rai@gmail.com","FirstName":"Robiin","LastName":"Rai","DOB":"1999-12-03","Gender":"male","Phone":"9817849333","Address":"Jorpati","Bio":"Loremipsumm" } | { "status": 200, "message": "teacher data updated"} |