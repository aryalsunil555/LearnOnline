...
2. run the following command:
  ...
  Scenario Outline: Get course data
    * Get the service api "<URL>" and i should get the '<expectval>'
    Examples: 
      | URL                                 | expectval                                                                                                                                                                                                                                                                                                                           |
      | http://localhost:3000/get/courses/1 | { "status": 200,"message": "Course data fetched","info": {"id": 1,"title":"Java","description":"this is good course","credit":20,"fee":2000,"course_image":"abc.jpg","start_date":"2019-09-23T13:03:47.000Z","end_date":"2019-09-23T13:03:47.000Z","createdAt": "2019-09-23T13:03:47.000Z","updatedAt": "2019-09-23T13:03:47.000Z"} |