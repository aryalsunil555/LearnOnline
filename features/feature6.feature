...
2. run the following command:
  ...
  Scenario Outline: Put student update
    * Post to service api "<URL>" with '<data>' and I should get the '<expectval>'
    Examples: 
      | URL                                    | data                                                                                                                                         | expectval                                           |
      | http://localhost:3000/student/update/1 | { "FirstName":"Robin","LastName":"Rai","Address":"Jorpati","DOB":"1999-12-03","Phone":"9817849333","Gender":"male","Email":"rai@gmail.com" } | { "status": 200, "message": "student data updated"} |