...
2. run the following command:
  ...
  Scenario Outline: Get teacher data
    * Get the service api "<URL>" and i should get the '<expectval>'
    Examples: 
      | URL                                 | expectval                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
      | http://localhost:3000/get/teacher/1 | { "status": 200,"message": "Teacher data fetched","info": {"status": 200,"message": "Teacher data fetched","info": {"id": 1,"first_name": "Robiin","last_name": "Rai","dob": "1999-12-03T00:00:00.000Z","gender": "male","phone": "9817849333","address": "Jorpati","email": "rai1@gmail.com","profile_image": null,"bio": "Loremipsum","verify": "0","password": "$2b$10$0BTH5Mv19wQsi3dcypHdHuFDhuJNFpBwpSoxXi.12k.fIAdsxe5NS","studentID": 1,"createdAt": "2019-09-30T05:07:22.000Z","updatedAt": "2019-09-30T05:07:22.000Z"}} |